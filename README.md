...
- **Per-Photo Placement**: Drag and resize the selected photo inside the shared frame or custom photo slot. Each photo keeps its own position and size in the batch export.
